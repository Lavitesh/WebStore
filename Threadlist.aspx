<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Threadlist.aspx.cs" Inherits="WebStore.Threadlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <div class="container">
                <asp:Label runat="server" ID="TypeName" CssClass="col-12 form-control btn-dark text-center"></asp:Label>

                <asp:Label ID="emptylist" CssClass="col-12 form-control" runat="server" Visible="false"></asp:Label>                
