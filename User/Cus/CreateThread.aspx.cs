    ...
    public partial class CreateThread : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    Status.Text = "Thread already Exists. Check again or try with another Name and dont use alpha numeric keywords.";
                }
            }
        }
        ...
        void UpdateForumDatabase()//Updates database and send control to upload fles to save files.....
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("StarterType", "C");
                cmd.Parameters.AddWithValue("Starter", Session["Customer"].ToString());
                cmd.ExecuteNonQuery();
