...
{
    public partial class ForumDev : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/User/Dev/ThreadListDev.aspx?type=" + (sender as LinkButton).Attributes["CustomParameter"].ToString());
        }
