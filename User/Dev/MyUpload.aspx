<%@ Page Title="" Language="C#" MasterPageFile="~/User/Dev/Developer.Master" AutoEventWireup="true" CodeBehind="MyUpload.aspx.cs" Inherits="WebStore.User.Dev.MyUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <asp:UpdatePanel runat="server">
        <ContentTemplate>  
            <section>
                <div class="single_product_details_area d-flex align-items-center col-12 ">
                ...
                <div>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="col-12"
