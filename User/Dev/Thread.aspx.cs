...
namespace WebStore.User.Dev
{
    public partial class Thread : System.Web.UI.Page
    {
        ...
        protected void Post_Click(object sender, EventArgs e)
        {
            ...
            string txtfilename = Session["Developer"].ToString() + "%D%" + DateTime.Now.ToString("dd-MM-yyyy_HH-mm-ss") + ".txt";
            string path = Server.MapPath("~/Forums/" + type + "/" + thread + "/" + txtfilename);
            try
            {     
        ...
        void CreateTable()
        {
            try
            {
                ...
                else
                {
                    ...
                    emptylist.Text = "No posts available";
                }
            }
            catch (Exception ex)
            {
        ...
        public bool getvisibility(string str,string utype)
        {
            if (Session["Developer"].ToString() == str && utype == "D")
                return true;
            else
                return false;
        } 
