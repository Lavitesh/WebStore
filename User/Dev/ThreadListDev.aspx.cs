...
{
    public partial class ThreadListDev : System.Web.UI.Page
    {
        ...
        protected void GDThreadList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "GoToThread")
            {
                ...
                Response.Redirect("~/User/Dev/Thread.aspx?type=" + cmdargs[1] + "&thread=" + cmdargs[0]);
            }
        }
        ...
        void CreateTable()
        {
            ...
            try
            {
                ...
                {                    
                    ...
                    emptylist.Text = "No Discussions. Start a new <a href='CreateThread.aspx?type="+ type +"' style='font-size:100%'>Discussion</a>";                    
                }
                else 
                {
                    Label lbl = new Label()
                    {
                        Text = "Start a new <a href='CreateThread.aspx?type=" + type + "' style='font-size:100%'>Discussion</a>",
